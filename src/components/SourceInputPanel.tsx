...
export function SourceInputPanel({ state, onSourceTextChange, onQuestionTypeChange, onQuestionCountChange, onGenerate, onRetry }: Props) {
  return (
    <div className="panel">
      <div className="input-card">
        <label htmlFor="sourceText">학습 자료</label>
        <textarea id="sourceText" value={state.sourceText} onChange={e => onSourceTextChange(e.target.value)} placeholder="예: 자바스크립트의 변수 선언은 let, const, var가 있습니다." />
      </div>
